...
class RunManager:
    ...
    def get_weighting_scheme(self, ltn, ltc, bm25):
        if ltn:
            return "ltn"
        elif ltc:
            return "ltc"
    ...
    def evaluate_baseline(self, collection, ltn, ltc, bm25, k1=None, b=None, text_processor="None"):
        ...
        scheme = self.get_weighting_scheme(ltn, ltc, bm25)
    ...
    def run_baseline_with_stop_and_stem(self):
        ...
        self.evaluate_baseline(collection, False, False, True, k1=1,
                               b=0.5, text_processor="stop671_porter")
    ...
    def run_baseline_with_stop_and_no_stem(self):
        ...
        self.evaluate_baseline(collection, False, False, True, k1=1,
                               b=0.5, text_processor="stop671_nostem")
    ...
    def run_baseline_with_no_stop_and_stem(self):
        ...
        self.evaluate_baseline(collection, False, False, True, k1=1,
                               b=0.5, text_processor="nostop_porter")
    ...
    def run_baseline_with_no_stop_and_no_stem(self):
        ...
        self.evaluate_baseline(collection, False, False, True, k1=1,
                               b=0.5, text_processor="nostop_nostem")
