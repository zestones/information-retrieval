...
def main(argv):
    ...
    parser.add_argument('--ltn', action='store_true', help='Use LTN weighting scheme')
    parser.add_argument('--ltc', action='store_true', help='Use LTC weighting scheme, length normalization and cosine similarity')
    parser.add_argument('--lnu', action='store_true', help='Use LNU weighting scheme')
