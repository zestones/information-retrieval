...
class CollectionStatistics:
    ...
    def display_statistics(self):
        ...
        print('Average Document Length:', sum(
            self.document_lengths) / self.collection_size)
        print('Average Term Length:', sum(self.term_lengths) / self.collection_size)
        print('Average Vocabulary Size:', sum(
            self.vocabulary_sizes) / self.collection_size)
        ...
        print('Standard Deviation of Document Lengths:',
              statistics.stdev(self.document_lengths))
        print('Standard Deviation of Term Lengths:',
              statistics.stdev(self.term_lengths))
        print('Standard Deviation of Vocabulary Sizes:',
              statistics.stdev(self.vocabulary_sizes))
